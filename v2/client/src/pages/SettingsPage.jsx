  ...
  return (
    <div className="p-6 max-w-[700px] mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Configure your business profile and notification channels</p>
      </div>
      ...
      <div className="bg-white rounded-xl p-6">
        ...
        <div className="flex flex-col gap-3">
          <label className="flex flex-col gap-1 text-[13px] font-medium text-gray-500">
            Business Name
            <input
              value={bizName}
              onChange={(e) => setBizName(e.target.value)}
              placeholder="My Business"
              className="py-2 px-3 rounded-lg border border-gray-200 text-sm outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </label>
          <label className="flex flex-col gap-1 text-[13px] font-medium text-gray-500">
            Phone Number
      ...
      {/* Business Contact */}
      <div className="bg-white rounded-xl p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-1">Business Contact</h2>
        <p className="text-[13px] text-gray-400 mb-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <label className="flex flex-col gap-1 text-[13px] font-medium text-gray-500">
            ...
            <input
              ...
              className="py-2 px-3 rounded-lg border border-gray-200 text-sm outline-none focus:ring-2 focus:ring-emerald-500"
            />
            <span className="text-[11px] text-gray-300 italic">WhatsApp integration coming soon</span>
          </label>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-3">
          <label className="flex flex-col gap-1 text-[13px] font-medium text-gray-500">
            ...
            <input
              ...
              className="py-2 px-3 rounded-lg border border-gray-200 text-sm font-mono outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </label>
          <label className="flex flex-col gap-1 text-[13px] font-medium text-gray-500">
            Default Chat ID
      ...
      <div className="bg-white rounded-xl p-6 opacity-60">
        <h2 className="text-lg font-semibold text-gray-900 mb-1">More Channels</h2>
